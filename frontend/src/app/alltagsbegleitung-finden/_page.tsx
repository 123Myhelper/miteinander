...
export const BASE_PATH: BasePath = "/alltagsbegleitung-finden";

export function buildMetadata(locale: AuthorityLocale): Metadata {
  const { meta } = getAlltagsbegleitungFindenContent(locale);
...
function buildStructuredData(locale: AuthorityLocale) {
  const content = getAlltagsbegleitungFindenContent(locale);
...
export default function AlltagsbegleitungFindenPage({
  ...
  const { meta, faq, related } = getAlltagsbegleitungFindenContent(locale);
      ...
      >
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <div className="space-y-4 break-words text-base leading-7 text-muted sm:text-lg sm:leading-8">
            <SectionBedarf locale={locale} />
            <SectionWege locale={locale} />
            <SectionVereinbarung locale={locale} />
